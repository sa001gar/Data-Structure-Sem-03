...
int main() {
    ...
    l1 = concat(l1, l2);
    printf("Concatenated: "); display(l1);
    l1 = delete(l1, 20);
    printf("After Deletion: "); display(l1);
    l1 = reverse(l1);
    printf("Reversed: "); display(l1);
    int pos = search(l1, 10);
    ...
    return 0;
        ...
        <div class="output-container bg-orange-200 p-4 rounded-md shadow-md mt-1">
          <h3 class="text-lg font-semibold">Expected Output:</h3>
          <pre>List 1: 30 20 10\nList 2: 15 5\nConcatenated: 30 20 10 15 5\nAfter Deletion: 30 10 15 5\nReversed: 5 15 10 30\nFound at position 2</pre>
        </div>
      `
    },
    {
  question: "4. Implement stack using arrays. Include functions for push, pop, display, and exit.",
  solution: `
    <div class="code-container bg-gray-600 p-4 rounded-md shadow-md">
      <button class="copy-btn" onclick="copyCode(this)">Copy Code</button>
      <pre><code class="language-c">
...
int main() {
    ...
    <div class="output-container bg-orange-200 p-4 rounded-md shadow-md mt-1">
      <h3 class="text-lg font-semibold">Expected Output:</h3>
      <pre>1.Push 2.Pop 3.Display 4.Exit
Choice: 1
Enter value: 10
...
{
  question: "5. Implement queue using arrays. Include functions for enqueue, dequeue, display, and exit.",
  solution: `
    <div class="code-container bg-gray-600 p-4 rounded-md shadow-md">
      <button class="copy-btn" onclick="copyCode(this)">Copy Code</button>
      <pre><code class="language-c">
...
int main() {
    ...
    <div class="output-container bg-orange-200 p-4 rounded-md shadow-md mt-1">
      <h3 class="text-lg font-semibold">Expected Output:</h3>
      <pre>1.Enqueue 2.Dequeue 3.Display 4.Exit
Choice: 1
Enter value: 10
